...
function Help {
    "Updates the AssemblyVersion and AssemblyFileVersion of AssemblyInfo.cs files`n"
    ".\updateFileVersion.ps1 [VersionNumber] -path [SearchPath]`n"
